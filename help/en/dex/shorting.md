...
The InsurChain network is capable of issuing any amount of any BitAsset and lend
...
The  network is capable of margin calling those positions that do not
...
particular bitAsset to hand it over to the InsurChain network. After that, the
