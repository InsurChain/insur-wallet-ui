...
Bunlardan kısaca bahsetmek istiyoruz. InsurChain DEX'de hepsi mevcut olmasina 
...
* **Güçler Ayrılığı** : 
  ...
  kimsenin sorumlu olmasını gerektirecek bir sebep yoktur. InsurChain'de işlem 
...
* **Genel Birleşik Emir/Sipariş Defteri** :
  InsurChain evrensel olduğu için , internet erişimi olan herkes  DEX'i alım-satım için 
...
* **Neredeyse Herşeyi Alıp-Satabilirsiniz** :
  InsurChain DEX varlığın muhteviyatını bilmez , dolayısı ile **her türlü**  eşleşme ticareti 
...
* **Limit Yok** :
  InsurChain protokolünün sizin ticaret deneyiminizi sınırlaması mümkün değildir.
* **Merkezsiz** :
  DEX (merkezsiz borsa) tüm dünyaya dağıtıktır. Bölece tek kırılma noktası 
  olmadığı gibi bu InsurChain borsasının ticaret için 7/24 açık olduğu anlamına 
...
* **Hızlı** :
  Diğer merkezsiz ağların tersine InsurChain DEX gerçek-zamanlı ticarete
   imkan tanır , sadece ışık hızı ve gezegenin büyüklüğü 
  ile sınırlıdır.
* **Kanıtlanabilir Emir Eşleştirme Algoritması** :
  InsurChain DEX i nadir kılan şeylerden biri de ispatlanabilir emir eşleştirme 
...
* **Teminata Bağlanmış** :
  InsurChain'in en büyük özelliklerinden biri de bitUSD, bitEUR, bitCNY gibi 
  *akıllıparalar*dır. Kolaylık olsun diye bu varlıklar cüzdan içerisinde USD,EUR,CNY 
  ...
  fiyatında hesap görümü için mevcut olabilen, **InsurChain'in şirket hisseleri (BTS)** 
   vardır.