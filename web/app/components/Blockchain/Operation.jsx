            ...
            column = (
                <span >
                    <TranslateWithLinks
                        string="operation.upload_hash"
                        keys={[
                            {type: "from", value: op[1].from, arg: "from"},
                            {type: "file_name", value: op[1].file_name, arg: "file_name"},
                            {type: "file_size", value: op[1].file_size, arg: "file_size"},
                            {type: "file_format", value: op[1].file_format, arg: "file_format"},
                            {type: "policy_hash_code", value: op[1].policy_hash_code, arg: "policy_hash_code"}
                        ]}
                    />
