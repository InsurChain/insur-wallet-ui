            ...
            case "limit_order_create":
                ...
                case "account_upgrade":
                    if(op[1].policy_flag)
                    {
                        ...
                        rows.push(
                            <tr key={key++}>
                                <td><Translate component="span" content="policy.policy_hash_code" /></td>
                                <td>{op[1].policy_hash_code.toString()}</td>
                            </tr>
                        );
                    }
                    else{
                ...
                case "policy":
                    ...
                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="policy.file_name" /></td>
                            <td>{op[1].file_name.toString()}</td>
                        </tr>
                    );
                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="policy.file_size" /></td>
                            <td>{op[1].file_size.toString()}</td>
                        </tr>
                    );
                    rows.push(
                        <tr key={key++}>
                            <td><Translate component="span" content="policy.file_format" /></td>
                            <td>{op[1].file_format.toString()}</td>
                        </tr>
                    );
                    rows.push(
                        <tr key={key++}>
