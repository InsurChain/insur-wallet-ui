    ...
    render() {
        ...
        if(this.props.error || this.props.included) {
            header = this.props.error ? (
                <div style={{minHeight: 100}} className=" modal-header has-error">
                    <Translate component="h3" content="transaction.broadcast_fail" />
                    <h6>{this.props.error}</h6>
                </div>
                ) :
                (
                <div style={{minHeight: 100}} className="modal-header">
            ...
            button_group = (
                <div className="button-group">
                    <div className="grid-block full-width-content">
                        <div className={confirmButtonClass} style={{width: "100px"}} onClick={this.onConfirmClick.bind(this)}>
                            {this.props.propose ?
                                <Translate content="propose" />:
                                <Translate content="transfer.confirm" />
                            }
                        </div>
                        <div className="button" style={{width: "100px"}} onClick={this.onCloseClick.bind(this)}>
