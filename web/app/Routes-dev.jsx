...
//hanyang add for insurlist
import AccountInsurList from "./components/Account/AccountInsurList";
import GetAllInsurListData from "./components/Account/GetAllInsurListData";
...
const routes = (
    <Route path="/" component={App} onEnter={willTransitionTo}>
        ...
        <Route path="/account/:account_name" component={AccountPage} >
            ...
            <Route path="insurList" component={AccountInsurList} />
