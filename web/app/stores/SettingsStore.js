...
const CORE_ASSET = "INSUR"; // Setting this to BTS to prevent loading issues when used with BTS chain which is the most usual case currently
...
class SettingsStore {
    constructor() {
        ...
        this.defaultSettings = Immutable.Map({
            locale: "cn",
            apiServer: "ws://witnode.insurchain.org",
            faucet_address: "http://47.254.50.233:3000",
            unit: CORE_ASSET,
            showSettles: false,
        ...
        let apiServer = [
            {url: "ws://witnode.insurchain.org", location: "Hong Kong"},
            {url: "wss://witnode.insurchain.io", location: "Silicon Valley"},
